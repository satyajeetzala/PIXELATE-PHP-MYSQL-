    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="about-content">
          ...
          <p class="about-text">Welcome to Pixelate! We are a passionate community of digital artists, creators, and enthusiasts who come together to celebrate the beauty and innovation of digital art.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="address-content">
          ...
          <p class="address-text">Pixelate<br>
